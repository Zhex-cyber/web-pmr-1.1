                            ...
                            <div class="col-12 col-sm-8 col-md-4 col-lg-12 px-xl-2 mx-auto">
                                ...
                                <form class="auth-login-form mt-2" action="{{route('login')}}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('nis') is-invalid @enderror" id="login-nis" type="text" name="nis" value=" {{old('nis')}} " placeholder="Masukan Nis" aria-describedby="login-nis" autofocus="" tabindex="1" />
                                        @error('nis')
