        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            @elseif(Auth::user()->role == 'Anggota')
              <li class="nav-item {{ (request()->is('murid/pembayaran')) ? 'active' : '' }}">
                <a class="d-flex align-items-center" href=" {{route('halaman-download-apk')}} "><i data-feather="dollar-sign"></i>
                    <span class="menu-title text-truncate" data-i18n="Books"> Download APK Absensi </span>
                </a>
              </li>
