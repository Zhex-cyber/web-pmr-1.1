                                    ...
                                    <div role="tabpanel" class="tab-pane active" id="account-vertical-general" aria-labelledby="account-pill-general" aria-expanded="true">
                                        ...
                                        <div class="media">
                                            <a href="javascript:void(0);" class="mr-25">
                                                ...
                                                @else
                                                    <img src="{{asset('public/images/profile/' .$profile->foto_profile)}}" id="account-upload-img" class="rounded mr-50" alt="profile image" height="80" width="80" />
                                                @endif
                                            </a>
                                        </div>
                                        <!--/ header media -->
                                        ...
                                        <form class="validate-form mt-2" action=" {{route('profile-settings.update', $profile->id)}}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12 col-sm-6">
                                                    <div class="form-group">
                                                        <label for="account-nis">NIS</label>
                                                        <input type="text" class="form-control" name="nis" value="{{$profile->nis}}" readonly />
                                                    </div>
                                                </div>
                                                <div class="col-12 col-sm-6">
                                                    <div class="form-group">
